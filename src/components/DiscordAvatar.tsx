...
function DiscordAvatar() {
    ...
    return (
        ...
        <button onClick={() => Signout(()=> window.location.reload())} className=" px-2 rounded-lg text-stone-500 dark:text-stone-300 font-medium group-hover:bg-stone-400 group-hover:text-stone-900">Signout</button>
        </>
    );
}
