                ...
                <PageWrapper>
                    <div className="col-start-3 col-end-7 flex flex-col">
                        <ContentPanel>
                            ...
                            <div className="py-4">Roster is: {(lockInfo.End === "FORCED" || lockInfo.Start === "FORCED") ? "FORCED " : ""} {lockInfo.Value} {(lockInfo.End === "FORCED" || lockInfo.Start === "FORCED") ? "" : ("- Roster will " + ((lockInfo.Value !== "OPEN") ? "unlock" : "lock") + " at " + ((lockInfo.Value !== "OPEN") ? lockInfo.End : lockInfo.Start) + " ET")}</div>
