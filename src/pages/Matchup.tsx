                    ...
                    <tbody>
                        {teamA.Players.map((item: any, i: any) => (
                            <tr key={"row" + item.PlayerID + "-" + teamB.Players[i].PlayerID}>
                                <td key={"name-a" + item.PlayerID} className="border w-2/12 px-2 py-2 border-stone-600 font-normal text-sm"><Link to={"/player/" + item.PlayerID}><Chip textSize="sm">{item.PlayerName}</Chip></Link></td>
                                <td key={"team-a" + item.PlayerID} className="border w-1/12 text-center px-2 py-2 border-stone-600 font-normal text-sm">{item.ProTeamTag}</td>
                                <td key={"points-a" + item.PlayerID} className="border w-1/12 text-center px-2 py-2 border-stone-600 font-normal text-sm">{item["Result Rows"]}</td>
                                <td key={"rows-a" + item.PlayerID} className="border w-1/12 text-center px-2 py-2 border-stone-600 font-normal text-sm">{item.Points}</td>
                                <td key={"vs" + item.PlayerID} className="border w-1/12 text-center px-2 py-2 border-stone-600 bg-stone-600 font-normal text-sm">{Role(item.FantasyRole)}</td>
                                <td key={"rows-b" + item.PlayerID} className="border w-1/12 text-center px-2 py-2 border-stone-600 font-normal text-sm">{teamB.Players[i].Points}</td>
                                <td key={"points-b" + item.PlayerID} className="border w-1/12 text-center px-2 py-2 border-stone-600 font-normal text-sm">{teamB.Players[i]["Result Rows"]}</td>
                                <td key={"team-b" + item.PlayerID} className="border w-1/12 text-center px-2 py-2 border-stone-600 font-normal text-sm">{teamB.Players[i].ProTeamTag}</td>
                                <td key={"name-b" + item.PlayerID} className="border w-2/12 px-2 py-2 border-stone-600 font-normal text-sm"><Link to={"/player/" + teamB.Players[i].PlayerID}><Chip align="end" textSize="sm">{teamB.Players[i].PlayerName}</Chip></Link></td>
                            </tr>
                        ))}
                    </tbody>
                </table>
